...
let cat1 = new Cat('Bruce', 11, 'black');
console.log(cat1);
...
class Wizard{
  ...
  castSpell() {
    console.log(`Hey ${this.name} has cast ${this.favoriteSpell}`);
  }
}
...
let faythsPhone = new Phone('Apple', 'Iphone11', '64G', 'Mint', '100');
let willardsPhone = new Phone('Pixel', '5', '256G', 'Black', '700');
let JessicasPhone = new Phone('Apple', 'Iphone11', '64G', 'White', '101');
/* 
...
faythsPhone.changePrice(50);
console.log(faythsPhone);
/*
...
class Vehicle{
  ...
  move(miles){
    this.mileage += miles;
    console.log(`This is how many miles we are at ${this.mileage}`)
  }
...
//Code Here
let myFirstVehicle = (4, "Lighting Red", 100);
...
let myFirstMotorcycle = new MotorCycle(7, 'yellow', 100000, 'Harley', true);
